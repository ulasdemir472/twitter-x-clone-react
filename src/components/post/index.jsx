...
const Post = ({ post }) => {
  return (
    <div className="px-4 py-3 border-b border-[color:var(--background-third)] flex gap-3 relative before:absolute before:z-[-1] before:transition-colors before:opacity-40 before:inset-0 before:hover:bg-[color:var(--background-secondary)] cursor-pointer">
      <img
      ...
      <div className="flex-1">
        <header className="leading-5 flex items-center gap-2 mb-0.5">
          <a href="#" className="hover:underline font-bold flex items-center">
