...
const AppearanceModal = ({ close }) => {
  ...
  return (
    <div className="w-[600px]">
      <h3 className="mt-8 mb-3 leading-7 text-[23px] font-extrabold text-center">
        Görünümü özelleştir
      </h3>
      <div className="p-8 pt-0">
        <p className="text-center text-[color:var(--color-baseSecondary)] leading-5 text-[0.938rem] mb-5">
          These settings affect all the X accounts on this browser.
        </p>
        <div className="mx-6 mb-4">
          <div className="border border-[color:var(--background-third)] py-3 px-4 gap-3 rounded-2xl flex">
            <img
              ...
              <header className="mb-0.5 leading-5 flex items-center">
                <div className="font-bold flex items-center">
                  ...
                  <svg
                    ...
                    className=" text-blue-500 ml-0.5 mt-0.5"
                    height={18.75}
                  >
                    <path
                      fill="currentColor"
        ...
        <div className="grid gap-2">
          <section>
            <h6 className="text-[color:var(--color-baseSecondary)] mb-1 leading-5 text-[13px] font-bold">
              Font Boyutu
            </h6>
            <div className="p-4 flex gap-5 mb-1 items-center bg-[color:var(--background-secondary)] rounded-2xl">
              <div className="text-[0.813rem] font-normal">Aa</div>
              ...
              <div className="text-[1.25rem] font-semibold">Aa</div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="py-3 mb-1 gap-2 flex justify-around items-center bg-[color:var(--background-secondary)] rounded-2xl">
              {colors.map((c, index) => {
                return (
                  <button
                    key={index}
                    style={{ "--bg": c.primary }}
                    className="w-[40px] h-[40px] rounded-full bg-[color:var(--bg)] flex items-center justify-center"
                    onClick={() => {
                      setColor({
                        ...color,
                        ...c,
          ...
          <section>
            ...
            <div className="py-2 px-4 mb-1 gap-2 grid grid-cols-3 bg-[color:var(--background-secondary)] rounded-2xl">
              <button
                onClick={() => {
                  setBackgroundColor({
                    name: "light",
                ...
                className={classNames(
                  "h-[62px] pr-3 pl-2 bg-white text-[#0f1419] border border-white/10 font-bold rounded  group flex items-center gap-1.5",
                  {
              ...
              <button
                ...
                className={classNames(
                  "h-[62px] pr-3 pl-2 bg-[#15202b] text-[#f7f9f9] border border-white/10 font-bold rounded  group flex items-center gap-1.5",
                  {
                    "!border-[color:var(--color-primary)] !border-2":
              ...
              <button
                ...
                className={classNames(
                  "h-[62px] pr-3 pl-2 bg-black text-[#f7f9f9] border border-white/10 font-bold rounded group flex items-center gap-1.5",
                  {
                    "!border-[color:var(--color-primary)] !border-2":
