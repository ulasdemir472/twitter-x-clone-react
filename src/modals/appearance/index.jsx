      ...
      <div className="p-8 pt-0">
        ...
        <div className="grid gap-2">
          <section>
            ...
            <div className="p-4 flex gap-5 items-center bg-[color:var(--background-secondary)] rounded-2xl">
              <div className="text-[13px] font-normal">Aa</div>
              <div className="h-1 bg-[color:var(--color-secondary)] flex-1 rounded-full"></div>
              <div className="text-[20px] font-semibold">Aa</div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="py-3 mb-3 gap-2 flex justify-around items-center bg-[color:var(--background-secondary)] rounded-2xl">
              {colors.map((c, index) => {
                return (
                  <button
                    key={index}
                    style={{ "--bg": c.primary }}
                    className="w-10 h-10 rounded-full bg-[color:var(--bg)] flex items-center justify-center"
                    onClick={() => {
                      setColor({
                        ...color,
                        primary: c.primary,
